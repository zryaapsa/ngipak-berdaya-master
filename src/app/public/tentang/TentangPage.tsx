    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <Card className="p-6">
        ...
        <p className="mt-2 leading-relaxed text-gray-700">
          <strong>Ngipak Berdaya</strong> adalah platform informasi digital
          untuk mendukung potensi <strong>Desa Ngipak</strong>, khususnya dalam
          promosi <strong>UMKM lokal</strong> dan penyebaran{" "}
          <strong>informasi kesehatan</strong>. Website ini dirancang agar warga
          dan pengunjung dapat menemukan produk UMKM dan menghubungi pelaku
          usaha melalui WhatsApp secara mudah.
        </p>
        ...
        <div className="mt-4 rounded-2xl border border-gray-100 bg-gray-50 p-4 text-sm text-gray-700">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            ...
            <li>
              Menyajikan informasi kesehatan yang ringkas dan mudah dipahami.
            </li>
          </ul>
        </div>
        ...
        <p className="mt-4 text-sm text-gray-500">
          ...
          <strong>KKN-T 35 Universitas Duta Bangsa Surakarta</strong> (Periode
          2025/2026) sebagai bagian dari program pengabdian masyarakat.
        </p>
      </Card>
      ...
      <Card className="border-l-4 border-l-green-500 p-6">
        ...
        <p className="mt-2 text-sm text-gray-600">
          Bagi warga Desa Ngipak yang memiliki usaha dan ingin ditampilkan di
          website ini, ikuti langkah berikut:
        </p>
        ...
        <ul className="mt-4 space-y-3">
          <li className="flex gap-3">
            ...
            <span className="text-gray-700">
              Siapkan foto produk yang jelas (minimal 1–3 foto) dan deskripsi
              singkat usaha.
            </span>
          </li>
          ...
          <li className="flex gap-3">
            ...
            <span className="text-gray-700">
              Pastikan nomor WhatsApp aktif untuk menerima pesan dari calon
              pembeli.
            </span>
          </li>
          ...
          <li className="flex gap-3">
            ...
            <div className="text-gray-700">
              Hubungi admin/pengelola website (perangkat desa bidang informasi)
              untuk pengajuan data UMKM.
